export const imagesArray = [
  { src: "./img/image-1.png", alt: "Girl in a library" },
  { src: "./img/image-2.png", alt: "Sculptures" },
  { src: "./img/image-3.png", alt: "Library" },
  { src: "./img/image-4.png", alt: "Building's facade" },
  { src: "./img/image-5.png", alt: "Library shelves" },
];
...
export const cardsArray = [
  {
    winter: [
      ...
      { src: "./img/book-2.png", alt: "The Cackle book photo" },
      ...
      {
        src: "./img/book-3.png",
        alt: "Dante: Poet of the Secular World book photo",
      },
  ...
  },
  {
    spring: [
      ...
      { src: "./img/book-5.png", alt: "The Body book photo" },
      ...
      {
        src: "./img/book-6.png",
        alt: "The Carry: A Memoir of Survival on Stolen Land book photo",
      },
      ...
      { src: "./img/book-7.png", alt: "The Days of Distraction book photo" },
      ...
      { src: "./img/book-8.png", alt: "The Dominicana book photo" },
    ],
  },
  {
    summer: [
      ...
      { src: "./img/book-9.png", alt: "The Crude: A Memoir book photo" },
      ...
      {
        src: "./img/book-10.png",
        alt: "The Let My People Go Surfing book photo",
      },
      ...
      {
        src: "./img/book-11.png",
        alt: "The The Octopus Museum: Poems book photo",
      },
  ...
  },
  {
    autumn: [
      ...
      {
        src: "./img/book-15.png",
        alt: "The Rickey: The Life and Legend book photo",
      },
      ...
      {
        src: "./img/book-16.png",
        alt: "The Slug: And Other Stories book photo",
      },
    ],
  },
];
